...
{
	partial class Approchedtransfersotherclubs
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "Approchedtransfersotherclubs";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Approched transfers from other clubs";
